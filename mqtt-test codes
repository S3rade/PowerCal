...
TLS_CERT_PATH = "/root/cost_vol/script/cacert/ca.cert
...
def connect(client, username, password, port):
    global connected
    ...
    if not client.is_connected():
        ...
        client.tls_set(ca_certs="/root/cost_vol/script/cacert", certfile="ca.cert",
                            keyfile="ca.key", cert_reqs=ssl.CERT_REQUIRED,
