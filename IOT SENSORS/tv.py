...
mqttc.tls_set('/root/cost_vol/scripts/cacert/ca.crt') #use TLS 
...
urlLive = "http://172.16.0.13:8080/add/" + "samsungTv" + "?status=" + statusappliance + "&tvChannel=%s" %tvChannel + "&editedBy=" + editedBy
urlLogs = "http://172.16.0.13:8080/add/" + "samsungTv" + "?status=" + statusappliance + "&tvChannel=%s" %tvChannel + "&editedBy=" + editedBy
print(urlLive) 
